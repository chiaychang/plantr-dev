...
module.exports = {
    ...
    'facebookAuth' : {
        ...
        'callbackURL'     : 'https://plantr-live.herokuapp.com/auth/facebook/callback',
    ...
    'twitterAuth' : {
        ...
        'callbackURL'        : 'https://plantr-live.herokuapp.com/auth/twitter/callback'
    },

    'googleAuth' : {
        'clientID'         : '542620950462-qcv465k0sc50q0phvoj2l3m5lnase691.apps.googleusercontent.com',
        'clientSecret'     : 'dy8R_gBDd9DWbMabQpC6Xpx4',
        'callbackURL'      : 'https://plantr-live.herokuapp.com/auth/google/callback'
    }
